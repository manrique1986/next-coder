export const productos = [
    ...
    {
      id: 8,
      nombre: "Rúcula con Jamón",
      descripcion:
        "Pizza con mozzarella, jamón crudo y rúcula fresca. La Pizza Rúcula con Jamón es conocida por su combinación de sabores frescos y salados, con el toque distintivo del jamón crudo y la rúcula.",
      precio: 11.49,
      imagen: "/ruculaconjamon.jpg",
      category: "MasaPan"
    },
    {
      id: 9,
      nombre: "Calabresa",
      descripcion:
        "Pizza con salame calabresa, mozzarella y salsa de tomate. La Calabresa ofrece un sabor picante y robusto con el salame, combinado con el queso derretido.",
      precio: 11.49,
    ...
    },
    {
      ...
      nombre: "Napolitana",
      descripcion:
        "Pizza con salsa de tomate, mozzarella y jamón. La Napolitana es clásica y deliciosa, con la combinación de jamón y queso sobre una base de salsa de tomate.",
      precio: 10.49,
    ...
    },
    {
      ...
      descripcion:
        "Pizza con jamón, pimientos morrones, mozzarella y salsa de tomate. Esta pizza es popular por la combinación de jamón y pimientos, añadiendo un toque dulce y salado.",
      precio: 11.99,
      imagen: "/jamonymorron.jpg",
      category: "MasaFina"
    },
    {
      id: 12,
      nombre: "Provolone",
      descripcion:
        "Pizza con queso provolone fundido y orégano. La Pizza Provolone se destaca por su sabor fuerte y distintivo del queso provolone, ideal para los amantes del queso.",
      precio: 9.99,
